<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddVideo.aspx.cs" Inherits="Revide.AddVideo" %>
...
<div class="container">
 ...
 <div class="form-group">
            ...
            <div class="col-lg-8">
              <asp:TextBox id="type_text" class="form-control" runat="server" visible="true" value=""/></asp:Textbox> 
