<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="Revide.userloginpages.UserLogin" %>
                            ...
                            <div class="sminputs">
                                <div class="input full">
                                    <!--input class="string optional singininput" maxlength="255" id="user-email"  placeholder="Email"
                                        type="email" size="50" /-->
                                        <asp:TextBox ID="login_email" runat="server" class="string optional singininput" maxlength="255"  placeholder="Email"
                                        type="email" size="100"></asp:TextBox>
                                </div>
                            </div>
                            <div class="sminputs">
                                <div class="input full">
                                    <!--input class="string optional singininput" maxlength="255" id="user-pw"  placeholder="Password"
                                        ...
                                        <asp:TextBox ID="login_password" runat="server" class="string optional singininput" maxlength="255"  placeholder="Password"
                                        type="password" size="50"></asp:TextBox>
                                </div>
                            </div>
                            <div class="simform__actions">
